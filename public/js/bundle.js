...
},{}],"authenticate.js":[function(require,module,exports) {
"use strict";
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Logged in successfully!'); // Redirect after Logged In
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context.t0.response.data.message); // console.log(err.response.data);
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (location) {
    ...
    element.className = 'marker'; // Add the Marker

    new mapboxgl.Marker({
      element: element,
      anchor: 'bottom'
    }).setLngLat(location.coordinates).addTo(map); // Add information popup

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, ": ").concat(location.description, "</p>")).addTo(map); // Extends the map bounds to include current location
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'update-password' : 'update-profile';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./authenticate":"authenticate.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51Iih6gETtKG5xBkZenwQJ3C8MIf8xaAr3R8dSc9iSj34asWxzTuTfNxvYgCLWP5YiwWkcSi9Ny8sf6JjfdzmWA7400ulWNFk0K');
...
if (loginForm) {
  loginForm.addEventListener('submit', function (event) {
    ...
    (0, _authenticate.login)(email, password);
  });
}

if (logOutBtn) {
  logOutBtn.addEventListener('click', _authenticate.logout);
}
